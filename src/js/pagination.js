$(document).ready(function () {
    let list = document.querySelectorAll(".pagination ul")
    ...
    function navigateSinglePage(e) {
        ...
        if (!$(this).hasClass(CLASS_DISABLED)) {
            var $parent = $(this).closest(".pagination"),
                currActive = parseInt($parent.data("pagination"), list.childElementCount);
    ...
    function changePage(currActive) {
        var $list = $(this).find("li"),
            currActive = parseInt($(this).data(DATA_KEY), list.childElementCount);
